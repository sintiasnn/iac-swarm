...
echo "Attempting to store worker token in SSM with project and cluster prefix..."
if aws ssm put-parameter \
    ...
    echo "Successfully stored worker token in SSM with project and cluster prefix"
else
    echo "Failed to store worker token in SSM with project and cluster prefix"
fi

echo "Attempting to store manager token in SSM with project and cluster prefix..."
if aws ssm put-parameter \
    ...
    --overwrite \
    --region "$AWS_REGION"; then
    echo "Successfully stored manager token in SSM with project and cluster prefix"
else
    echo "Failed to store manager token in SSM with project and cluster prefix"
fi

echo "Attempting to store master IP in SSM with project and cluster prefix..."
if aws ssm put-parameter \
    ...
    --overwrite \
    --region "$AWS_REGION"; then
    echo "Successfully stored master IP in SSM with project and cluster prefix"
else
    echo "Failed to store master IP in SSM with project and cluster prefix"
fi
